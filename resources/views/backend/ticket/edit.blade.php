                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title"><a href="{{ route('ticket.index') }}"><i class="nav-icon fas fa-arrow-left"></i>  Ticket list</a></h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="{{ route('ticket.update',$ticket->id) }}" method="post">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <input type="number" class="form-control" name="ticket_price" value="{{ $ticket->ticket_price }}"
                                            placeholder="Price">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="seat_number" value="{{ $ticket->seat_number }}"
                                            placeholder="Price">
                                    </div>

                                    <div class="form-group">
                                        <label for="total_amount">Total Price</label>
                                        <input type="number" class="form-control" name="total_amount" value="{{ $ticket->total_amount }}"
                                            placeholder="Price">
                                    </div>
